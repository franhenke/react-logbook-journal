  ...
  return (
    <>
      ...
      <div className={`sidebar ${expanded ? 'sidebar--expanded' : ''}`}>
        <NavLinkComponent route={ROUTES.HOME} routeName="Home">
          <g
            fill="none"
            strokeWidth="2"
            strokeLinecap="round"
        ...
        <NavLinkComponent route={ROUTES.JOURNALS} routeName="Journals">
          <g
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
        ...
        <NavLinkComponent route={ROUTES.BOOKMARKS} routeName="Saved">
          <g
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
        ...
        <NavLinkComponent route={ROUTES.EXPLORE} routeName="Map">
          <g
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
